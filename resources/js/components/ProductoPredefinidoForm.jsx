...
function ProductoPredefinidoForm() {
    ...
    useEffect(() => {
        ...
        const loadUnidadesMedida = () => {
            axios
                .get("/api/lista_unidadesmedidapp", { headers })
                .then((res) => {
        ...
        if (id) {
            ...
            axios
                .get(`/api/productopredefinido/${id}`, { headers })
                .then((res) => {
                    const data = res.data;
                    setProductoPredefinido({
                        ...
                        variacion:
                            data.variacion === 1 || data.variacion === true,
    ...
    const handleSubmit = (e) => {
        ...
        if (id) {
            ...
            axios
                .put(`/api/productopredefinido/${id}`, dataToSend, { headers })
                .then((res) => {
            ...
            axios
                .post("/api/productopredefinido", dataToSend, { headers })
                .then((res) => {
                            ...
                            <div className="row g-2">
                                <div className="col-md-2">
                                    ...
                                    <input
                                        type="text"
                                        name="titulo"
                                        value={productoPredefinido.titulo}
                                ...
                                <div className="col-md-6">
                                    ...
                                    <input
                                        type="text"
                                        name="descripcion"
                                        value={productoPredefinido.descripcion}
                                        onChange={handleChange}
                            ...
                            <div className="row g-2 mt-2">
                                <div className="col-md-2">
                                    ...
                                    <input
                                        type="text"
                                        name="ancho"
                                        value={productoPredefinido.ancho}
                                        onChange={handleChange}
                                        placeholder="Ancho"
                                        className="form-control form-control-sm"
                                    />
                                ...
                                <div className="col-md-2">
                                    ...
                                    <input
                                        type="text"
                                        name="alto"
                                        value={productoPredefinido.alto}
                                        onChange={handleChange}
                                        placeholder="Alto"
                                        className="form-control form-control-sm"
                                    />
                                ...
                                <div className="col-md-2">
                                    ...
                                    <input
                                        type="text"
                                        name="profundidad"
                                        value={productoPredefinido.profundidad}
                                        onChange={handleChange}
                            ...
                            <div className="row g-2 mt-2">
                                ...
                                <div className="col-md-2">
                                    ...
                                    <input
                                        ...
                                        disabled={
                                            !productoPredefinido.variacion
                                        } // Deshabilitado si no está marcada
                                    />
                                </div>
                                <div className="col-md-2">
                                    <label className="form-label">
                        ...
                        <div className="row g-2 mt-2">
                            <div className="col-md-12">
                                ...
                                <input
                                    type="text"
                                    name="observaciones"
                                    value={productoPredefinido.observaciones}
                                    onChange={handleChange}
