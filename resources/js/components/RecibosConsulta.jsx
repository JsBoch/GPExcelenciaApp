...
const RecibosConsulta = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            header: "Facturas",
            accessorFn: (row) =>
                Array.isArray(row.detalles) ? row.detalles.length : 0,
            Cell: ({ row }) => {
                ...
                return (
                    <Button
                        variant="outlined"
                        size="small"
                        onClick={() => handleVerFacturas(row.original)}
                    >
    ...
    return (
        <Box sx={{ p: 2 }}>
            ...
            <Paper elevation={3} sx={{ mt: 2, p: 2 }}>
                ...
                <Box sx={{ display: "flex", gap: 2, mb: 2, flexWrap: "wrap" }}>
                    ...
                    <Autocomplete
                        ...
                        onChange={(_, val) =>
                            setClienteFiltro(val ? val.idcliente : "")
                        }
                        renderInput={(params) => (
                            <TextField
                                {...params}
          ...
          >
            ...
            <Dialog
                open={verFacturasOpen}
                onClose={() => setVerFacturasOpen(false)}
                maxWidth="md"
                fullWidth
            >
                ...
                <DialogActions>
                    <Button onClick={() => setVerFacturasOpen(false)}>
                        Cerrar
                    </Button>
                </DialogActions>
            </Dialog>
